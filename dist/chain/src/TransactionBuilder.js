...
var _bitsharesjsWsMes = require("bitsharesjs-ws-mes");
...
var TransactionBuilder = (function() {
    ...
    */
    ...
    TransactionBuilder.prototype.process_transaction = function process_transaction(
        ...
        if (
            _bitsharesjsWsMes.Apis.instance().chain_id !==
    ...
    TransactionBuilder.prototype.finalize = function finalize() {
        ...
        return new Promise(function(resolve, reject) {
            ...
            resolve(
                _bitsharesjsWsMes.Apis.instance()
                    .db_api()
                    ...
                    .then(function(r) {
                        ...
                        if (_this2.expiration === 0)
                            _this2.expiration =
                                base_expiration_sec() +
                                _bitsharesjsWsMes.ChainConfig.expire_in_secs;
    ...
    TransactionBuilder.prototype.get_type_operation = function get_type_operation(
        ...
        if (name === "proposal_create") {
            ...
            operation.expiration_time ||
                (operation.expiration_time =
                    base_expiration_sec() +
                    _bitsharesjsWsMes.ChainConfig.expire_in_secs_proposal);
            if (requiresReview) {
        ...
        promises.push(
            Promise.all(
                feeAssets.map(function(id) {
                    return _bitsharesjsWsMes.Apis.instance()
                        .db_api()
